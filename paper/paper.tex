...
While there has been a lot of research done for accelerating applications
using the GPU, most of them focus on only using the GPU for acceleration
instead of co-processing with the CPU.
